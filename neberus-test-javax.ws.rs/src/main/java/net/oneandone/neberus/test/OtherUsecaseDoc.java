...
@ApiUsecase(name = "this is a very long name for an usecase that does nothing", description = "just do it already",
            methods = {
                @ApiUsecaseMethod(
                        name = "This is an awesome method",
                        restClass = RestServiceWithInterfaceDoc.class,
                        description = "Call this first",
                        parameters = {
                            @ApiUsecaseParam(name = "pathParam123", value = "myId", valueHint = "this is the hint"),
